...
describe Grouping do
  ...
  describe "#setupWholeMessage" do 
    it "returns the title" do 
      ...
      @instruments_multi_hash_card.setupWholeMessage("instruments").include?("instruments").should be_true
    end
    it "returns a message body" do 
      ...
      @instruments_multi_hash_card.setupWholeMessage("instruments").include?("clarinet").should be_true
      @instruments_multi_hash_card.setupWholeMessage("instruments").include?("brass").should be_true
    end
  end
  ...
  describe "#returnsMessageBody" do 
    ...
    it "calls setupMessageBody if title refers to a object/hash" do 
      ...
      @pets_single_hash.returnsMessageBody("pets").include?("Fido").should be_true
    end
  end
  ...
  describe "#loopInArrayToSetupMessageBody" do 
    it "takes each 'value' for the main key and loops to create the message body - used for arrays" do 
      ...
      @cats_array_card.loopInArrayToSetupMessageBody("cats").include?("Muffin").should be_true
      @cats_array_card.loopInArrayToSetupMessageBody("cats").include?("Snowflake").should be_true
      @cats_array_card.loopInArrayToSetupMessageBody("cats", "fur").include?("tawny").should be_true
    end 
  end
  ...
  describe "#failedTitleMessage" do 
    it "returns failed message" do 
      ...
      @instruments_multi_hash_card.failedTitleMessage("foo").include?("associated").should be_true
    end 
  end
  ...
  describe "#formatsOneKeyValuePair" do 
    it "has title in the message" do 
      @phone_object_card.formatsOneKeyValuePair("phone").include?("phone").should be_true
    end 
    it "has the value in the message" do 
      @phone_object_card.formatsOneKeyValuePair("phone").include?("true").should be_true
    end
  end
